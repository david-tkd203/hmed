...
- [ ] Levantaste los servicios con `docker-compose up -d`
...
2. Realiza cambios y commit: `git commit -am 'Agregar feature'`
...
- 📧 Email: dev-team@hmed.tech
- 🐛 Issues: [GitHub Issues](https://github.com/tu-usuario/historico-clinico/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/tu-usuario/historico-clinico/discussions)
